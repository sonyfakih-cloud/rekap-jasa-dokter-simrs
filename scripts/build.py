...
function renderAll(){
  ...
  document.getElementById('kpiJasa').textContent = fmtInt(totalJasaPoin(d));
  ...
  Object.keys(jasaLabels).forEach(k => {
    ...
    card.innerHTML = `<div class="j-label">${jasaLabels[k]}</div><div class="j-value mono">${fmtInt(v/1000)}</div><div class="j-bar-track"><div class="j-bar-fill" style="width:${pct}%"></div></div>`;
